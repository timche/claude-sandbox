...
# makes it pleasant — oh-my-zsh, the prompt, the runtimes — comes from
...
#
# Copied rather than linked, so claude-dotfiles moves it aside to .zshrc.backup
# and takes over. Keep it minimal: everything here is a thing that has to keep
# working with no oh-my-zsh underneath it.
